...
function NavBar(props) {
  const { classes, openRegisterDialog, openLoginDialog, handleMobileDrawerOpen, handleMobileDrawerClose, mobileDrawerOpen, selectedTab } = props;
  const menuItems = [
    {
      link: "/",
      name: "Ticker Store",
    ...
    {
      link: "/odds-screen-store",
      name: "Odds Screen Store",
      icon: <BookIcon className="text-white" />,
    },
    // {
    //   link: "/gif-display-vertical",
    //   name: "Gif Display Vertical",
    //   icon: <BookIcon className="text-white" />,
    // },
    // {
    //   link: "/gif-display-horizontal",
    //   name: "Gif Display Horizontal",
    //   icon: <BookIcon className="text-white" />,
    // },
    {
      link: "/odds-screen/null",
      name: "Odds Screen Login",
    ...
    <div className={classes.root}>
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar className={classes.toolbar}>
          ...
          <div>
            <Hidden mdUp>
              <IconButton className={classes.menuButton} onClick={handleMobileDrawerOpen} aria-label="Open Navigation" size="large">
