...
function BasketballFirestick(props) {
  ...
  const teamBackgroundLinks = {
    ...
    NCAABASKETBALL: [
      {
        team: "Baylor Bears",
        homeCourtImage: "https://d1nnrx9kca53zl.cloudfront.net/images/2024/1/2/tcu_preview.jpg?width=1920&quality=80&format=jpg",
      },
    ],
    NBA: [
      { team: "Atlanta Hawks", homeCourtImage: "https://www.si.com/.image/t_share/MTY4MTk5MDc1NDU0OTIwNjA1/atlanta-hawks-court-design.jpg" },
      {
        team: "Boston Celtics",
        homeCourtImage:
      ...
      },
      {
        ...
        homeCourtImage: "https://www.charlotteobserver.com/latest-news/xli32x/picture245386640/alternates/FREE_1140/Court%20Image.jpg",
      },
      { team: "Chicago Bulls", homeCourtImage: "https://cdn.getyourguide.com/img/tour/3a3af9b900e9a46d.png/145.jpg" },
      { team: "Cleveland Cavaliers", homeCourtImage: "https://venuecoalition.com/wp-content/uploads/2018/01/Quicken-Loans-Arena-Packed-House.webp" },
      {
      ...
      { team: "Houston Rockets", homeCourtImage: "https://pbs.twimg.com/media/F-BV19FWIAE3782?format=jpg&name=4096x4096" },
      { team: "Denver Nuggets", homeCourtImage: "https://fhsroyalbanner.com/wp-content/uploads/2023/04/ball-arena-900x675.jpg" },
      {
      ...
      { team: "Golden State Warriors", homeCourtImage: "https://www.denverpost.com/wp-content/uploads/2019/08/SJM-L-CHASE-0827-5.jpg?w=620" },
      {
        team: "Indiana Pacers",
        homeCourtImage:
      ...
      { team: "Milwaukee Bucks", homeCourtImage: "https://newscdn2.weigelbroadcasting.com/9Tkhi-1496425944-51179-blog-9200005_G.jpg" },
      {
        team: "Minnesota Timberwolves",
        homeCourtImage: "https://d5c1j5k5drfk7.cloudfront.net/wp-content/uploads/2022/04/TW-2021.12.17-Lakers-1813.jpg",
      },
      { team: "New Orleans Pelicans", homeCourtImage: "https://cdn.getyourguide.com/img/tour/dac26284a07c1a5c.png/145.jpg" },
      { team: "New York Knicks", homeCourtImage: "https://cdn.nba.com/teams/uploads/sites/1610612752/2022/06/NYK_031518_0626.jpg" },
      {
        team: "Oklahoma City Thunder",
        homeCourtImage: "https://okcthunderwire.usatoday.com/wp-content/uploads/sites/36/2022/04/USATSI_15324008.jpg?w=1000&h=600&crop=1",
      },
      { team: "Orlando Magic", homeCourtImage: "https://www.kiacenter.com/assets/img/Orlando-Magic-Tip-Off-2018-slide-cac091c390.jpg" },
      { team: "Philadelphia 76ers", homeCourtImage: "https://cloudfront-us-east-1.images.arcpublishing.com/pmn/SKVJDA5NVZGADPRHQIGA33CENA.jpg" },
      { team: "Phoenix Suns", homeCourtImage: "https://www.sportsvideo.org/wp-content/uploads/2021/01/unnamed-1-6.jpg" },
      {
      ...
      { team: "San Antonio Spurs", homeCourtImage: "https://media2.sacurrent.com/sacurrent/imager/u/original/30079836/spurs.jpg" },
      {
      ...
      },
      {
        ...
        homeCourtImage: "https://s3.us-east-1.amazonaws.com/vnda-cockpit/www-streetopia-me/2021/02/02/6018b2cbefaa5wizards02.jpg",
      },
    ],
  };
  ...
  const getNFLGame = async () => {
    const id = game.id;
    return await fetch(`https://site.api.espn.com/apis/site/v2/sports/football/nfl/scoreboard?dates=20240211-20240211`)
      .then((response) => {
  ...
  const getNCAAGame = async () => {
    const id = game.id;
    return await fetch(`https://site.api.espn.com/apis/site/v2/sports/basketball/mens-college-basketball/scoreboard?groups=50&limit=900`)
      .then((response) => {
        return response.json();
      })
      .then((data) => {
  ...
  const getNetworkLogo = (network) => {
    const espnLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/ESPN%27s_Old_Logo.png/320px-ESPN%27s_Old_Logo.png";
    const cbsLogo = "https://www.pngall.com/wp-content/uploads/13/CBS-Logo-PNG-File.png";
    const foxLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/FOX_wordmark.svg/2560px-FOX_wordmark.svg.png";
    const nbcLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/NBC_logo.svg/567px-NBC_logo.svg.png";
    ...
    const nhlNetLogo = "https://awfulannouncing.com/wp-content/uploads/sites/94/2014/01/NHLNetwork.jpg";
    const peacockLogo = "https://www.peacocktv.com/static/peacock-toolkit/0.25.2/logo/peacock-wob.png";
    const ACCNLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/ACC_Network_ESPN_logo.svg/1024px-ACC_Network_ESPN_logo.svg.png";
    const ESPNPlusLogo = "https://cnbl-cdn.bamgrid.com/assets/72cfeeec0d56bc88c3a1e501ff9d3e3b141ea52d6af9e9ab417173a2491099f2/original";
    const ESPN2Logo = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/ESPN2_logo.svg/1280px-ESPN2_logo.svg.png";
    const TNTLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/TNT_TV_logo.svg/1200px-TNT_TV_logo.svg.png";
    const SECLogo = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/SEC_Network_logo.svg/2560px-SEC_Network_logo.svg.png";
    const BTNLogo = "https://upload.wikimedia.org/wikipedia/en/thumb/3/39/Big_Ten_Network_Logo.svg/1200px-Big_Ten_Network_Logo.svg.png";
    if (network.includes("CBS")) {
      return <img style={{ height: 25 }} src={cbsLogo} alt="network logo" />;
    } else if (network.includes("ESPN+")) {
      return <img style={{ height: 25 }} src={ESPNPlusLogo} alt="network logo" />;
    } else if (network.includes("ESPN2")) {
      return <img style={{ height: 25 }} src={ESPN2Logo} alt="network logo" />;
    } else if (network.includes("ESPN")) {
      return <img style={{ height: 25 }} src={espnLogo} alt="ESPN logo" />;
    } else if (network.includes("FOX")) {
      return <img style={{ height: 25 }} src={foxLogo} alt="network logo" />;
    } else if (network.includes("NBC")) {
      return <img style={{ height: 25 }} src={nbcLogo} alt="network logo" />;
    } else if (network.includes("FS1")) {
      return <img style={{ height: 25 }} src={foxSports1Logo} alt="network logo" />;
    } else if (network.includes("NBA")) {
      return <img style={{ height: 25 }} src={nbaTVLogo} alt="network logo" />;
    } else if (network.includes("NHL")) {
      return <img style={{ height: 25 }} src={nhlNetLogo} alt="network logo" />;
    } else if (network.includes("Peacock")) {
      return <img style={{ height: 25 }} src={peacockLogo} alt="network logo" />;
    } else if (network.includes("ACCN")) {
      return <img style={{ height: 25 }} src={ACCNLogo} alt="network logo" />;
    } else if (network.includes("TNT")) {
      return <img style={{ height: 25 }} src={TNTLogo} alt="network logo" />;
    } else if (network.includes("SEC")) {
      return <img style={{ height: 25 }} src={SECLogo} alt="network logo" />;
    } else if (network.includes("BTN")) {
      return <img style={{ height: 25 }} src={BTNLogo} alt="network logo" />;
    } else return null;
  };
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <img style={{ height: 150 + textSize * 10, width: 150 + textSize * 10 }} src={awayTeamData.team.logo} alt="away team logo" />
            <div style={{ textAlign: "left" }}>
              ...
              <Typography
                ...
                style={{
                  ...
                  margin: 0,
                  fontWeight: 400,
                  fontSize: textSize > 1 ? "1.5rem" : 1 + textSize + "rem",
                  marginBottom: 10,
                  marginTop: 10,
                }}
                color={"white"}>
                Overall: ({awayTeamData.records[0].summary}) Road: ({awayTeamData.records.find((x) => x.type === "road").summary}){" "}
              </Typography>
                  ...
                  .map((x, idx) => (
                    <div
                      style={{
                        ...
                        backgroundColor: awayTeamData.team.alternateColor ? "#" + awayTeamData.team.alternateColor : "white",
                        borderRadius: 10,
                        padding: 1,
                        width: "100%",
                        marginBottom: 10,
                      ...
                      key={idx}>
                      <div>
                        <img style={{ height: 40 }} src={x.leaders[0].athlete.headshot} alt="player pic" />
                      </div>
                      <div>
                        <Typography
                          variant={"h1"}
          ...
          <div
            ...
            <div
              ...
              {gameData.status.type.name !== "STATUS_FINAL" && gameData.status.type.name !== "STATUS_SCHEDULED" && (
                <Typography
                  variant={"h1"}
                  style={{
                ...
                <>
                  <Typography
                    ...
                    style={{
                      fontFamily: "RadleySans",
                      fontWeight: 400,
                      fontSize: textSize > 1 ? "2rem" : 2 + textSize + "rem",
                      marginTop: 100,
                    }}
                    color={"white"}>
                    {format(parse(gameData.status.type.detail.split(" at ")[0], "EEE, MMMM do", new Date()), "EEE, MMM do")}
                  </Typography>
                  <Typography
                    variant={"h1"}
                    style={{
              ...
              <div>
                {(game.sport === "NBA" || game.sport === "NCAABASKETBALL") &&
                  ...
                  ["fieldGoal", "threePoint", "freeThrow", "rebounds", "assists"].map((x, idx) => {
                    if (x === "fieldGoal") {
                      const awayData = awayTeamData.statistics.filter((x) => x.name.includes("fieldGoal"));
                      const homeData = homeTeamData.statistics.filter((x) => x.name.includes("fieldGoal"));
                      return (
                        <div
                          style={{
                            display: "flex",
                          ...
                          <div
                            style={{
                              backgroundColor: homeTeamData.team.alternateColor ? "#" + homeTeamData.team.alternateColor : "white",
                              padding: "3px 10px",
                              width: "100%",
                              borderRadius: 10,
                            }}>
                    ...
                    if (x === "threePoint") {
                      const awayData = awayTeamData.statistics.filter((x) => x.name.includes("threePoint"));
                      console.log("🚀 :", awayData);
                      const homeData = homeTeamData.statistics.filter((x) => x.name.includes("threePoint"));
                        ...
                        <div
                          ...
                          <div
                            ...
                            <Typography
                              ...
                              color={"#" + awayTeamData.team.color}>
                              {awayData.find((x) => x.name === "threePointFieldGoalPct").displayValue}%
                            </Typography>
                            <Typography
                              variant={"h1"}
                              style={{
                              ...
                              color={"#" + awayTeamData.team.color}>
                              {awayData.find((x) => x.name === "threePointFieldGoalsMade").displayValue}/
                              {awayData.find((x) => x.name === "threePointFieldGoalsAttempted").displayValue}
                            </Typography>
                          </div>
                          <div
                            style={{
                          ...
                          <div
                            ...
                            <Typography
                              ...
                              color={"#" + homeTeamData.team.color}>
                              {homeData.find((x) => x.name === "threePointFieldGoalPct").displayValue}%
                            </Typography>
                            <Typography
                              variant={"h1"}
                              style={{
                              ...
                              color={"#" + homeTeamData.team.color}>
                              {homeData.find((x) => x.name === "threePointFieldGoalsMade").displayValue}/
                              {homeData.find((x) => x.name === "threePointFieldGoalsAttempted").displayValue}
                            </Typography>
                          </div>
                        </div>
                      );
                    ...
                    if (x === "freeThrow") {
                      const awayData = awayTeamData.statistics.filter((x) => x.name.includes("freeThrow"));
                      const homeData = homeTeamData.statistics.filter((x) => x.name.includes("freeThrow"));
                      return (
                        <div
                          style={{
                            display: "flex",
          ...
          <div
            ...
            <img style={{ height: 150 + textSize * 10, width: 150 + textSize * 10 }} src={homeTeamData.team.logo} alt="away team logo" />
            <div style={{ textAlign: "right", display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
              ...
              <Typography
                ...
                color={"white"}>
                Overall: ({homeTeamData.records[0].summary}) Home: ({homeTeamData.records.find((x) => x.type === "home").summary})
              </Typography>
                    ...
                    <div
                      ...
                      <div>
                        ...
                        <Typography
                          ...
                          color={"#" + homeTeamData.team.color}>
                          {x.leaders[0].displayValue} {x.shortDisplayName !== "RAT" ? x.shortDisplayName : null}
                        </Typography>
                      </div>
                      <div>
                        <img style={{ height: 40 }} src={x.leaders[0].athlete.headshot} alt="player pic" />
        ...
        <div style={{ display: "flex", zIndex: 1000 }}>
          <SettingsIcon style={{ fontSize: 10, color: "white", marginLeft: 10 }} onClick={() => setIsSettingsOpen(true)} />
          <Typography
            variant={"h3"}
...
export default BasketballFirestick;
